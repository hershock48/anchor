...
export const pipMisconceptions = [
  ...
  },
  {
    ...
    truth:
      "ZIP code and credit score were banned as rating factors in 2020. Carriers moved to territories drawn from census tracts and grid systems instead, which is why Manchester, Chelsea and Saline still quote differently.",
  },
];

 ...
 * Ported from devine's AgreementAccept.
 *
 ...
 * send it. A false "you're all set" on a legal record would be worse than
 * the quote-form version of the same lie, and that one was ruled out first.
 */
